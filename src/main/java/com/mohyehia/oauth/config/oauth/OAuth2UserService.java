package com.mohyehia.oauth.config.oauth;

import com.mohyehia.oauth.config.oauth.user.OAuth2UserInfo;
import com.mohyehia.oauth.config.oauth.user.OAuth2UserInfoFactory;
